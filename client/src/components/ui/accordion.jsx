          ...
          <div key={index}>
            <h3>
              <button
                ...
                className="flex w-full items-center justify-between gap-3 px-5 py-5 text-left text-[15px] font-semibold text-gray-900 transition-colors hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                {item.question}
